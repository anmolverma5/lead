        ...
        <div class="col-12">
            ...
            <div class="card card-outline-info">
                ...
                <div class="card-body">
                    ...
                    <a type="button" href="{{ route('leads.create') }}" class="btn btn-success addButton"> + Add
                        Lead</a>

                    <form class="form-horizontal form-label-left input_mask" id="assignForm" method='post'
                        action="{{ route('searchLead') }}">
                        @csrf
                        <div class="mian-dp">

                            <div class="main-first">
                                <select name="source_id" class="form-control custom-select"
                                    data-placeholder="Select Campaign" tabindex="1">
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="wraping"><a href="{{ url('/leads', [$data['id']]) }}">{{
                                    ...
                                    <td>
                                        <!--<a href="{{ url('/feedbacks/add', [$data['id']]) }}"><span class="label label-info">Add Feedback</span></a>--->
                                        <a href="{{ url('/notes/view', [$data['id']]) }}">
                                            <span class="label label-warning">View All Notes</span>
                                        </a>
                                        <a href="{{ url('/leads', [$data['id']]) }}"><span
                                                class="label label-success">View</span></a>
                                        @if($data['status'] == 3)
                                        <a href="{{ url('/employee/lhs_report', [$data['id']]) }}">
                                            <span class="label label-warning">Report</span>
                                        </a>
                                        @endif
                                        <a href="{{ url('/leads/' . $data['id'] . '/edit') }}"><span
                                                class="label label-warning">Edit</span></a>

                                        <a href="{{ url('leads/delete', ['id' => $data['id']]) }}"><span
                                                class="label label-danger"
                                                onclick="return confirm('Are you sure you want to delete this lead ?')">Delete</span></a>
