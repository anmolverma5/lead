                                ...
                                <div class="tab-pane active" id="settings" role="tabpanel">
                                    ...
                                    @csrf
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="first_name" placeholder="Enter First Name" class="form-control form-control-line" value="{{ $data->first_name }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="last_name" placeholder="Enter Last Name" class="form-control form-control-line" value="{{ $data->last_name }}">
                                                </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-md-12">
                                                    <input type="text" name="phone_no" placeholder="Enter Phone No" class="form-control form-control-line" value="{{ $data->phone_no }}" readonly>
                                                </div>
