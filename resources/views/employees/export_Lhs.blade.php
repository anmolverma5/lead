                  ...
                  <div class="form-body ">
                     <div class="row p-t-20">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="first_name" name='first_name'class="form-control" readonly placeholder="Enter Contact Name" value="{{ $data->first_name .' '. $data->last_name}}" >
                     ...
                     <div class="row">
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="industry" name='industry'class="form-control" placeholder="Enter Industry" readonly value="{{ $data->industry }}">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="phone_no" name='phone_no'class="form-control" placeholder="Enter Cell Number" readonly value="{{ $data->phone_no }}">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              ...
                              <input type="text" id="email" name='email' class="form-control" placeholder="Enter Email" readonly value="{{ $data->email }}">
                              @if($errors->has('email'))
                     ...
                     <div class="row">
                        <div class="col-md-12">
                           <div class="form-group">
                              ...
                              <textarea placeholder="Enter Call Notes" id="call_notes" name='call_notes' class="form-control">{{ old('call_notes') }}</textarea>
                           </div>
                        </div>
                     </div>
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="control-label"></label>
                              <input type="text" id="meeting_teleconference" name='meeting_teleconference'class="form-control" placeholder="Teleconference" value="{{ old('meeting_teleconference') }}">
                     ...
                     <div class="row">
                        ...
                        <div class="col-md-6">
                           <div class="form-group">
                              <label class="control-label"></label>
                              <input type="text" id="contact_decision_maker" name='contact_decision_maker'class="form-control" placeholder="Yes/No" value="{{ old('contact_decision_maker') }}">
